//
//  vitereteVCChallengeModeDificil.h
//  Barce Memo 2013
//
...
@interface vitereteVCChallengeModeDificil :UIViewController <AVAudioPlayerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIAlertViewDelegate,ADBannerViewDelegate>
