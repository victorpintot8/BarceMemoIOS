...
@interface vitereteVCChallengeModeDificil :UIViewController <AVAudioPlayerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIAlertViewDelegate>
{
    sqlite3 *db;
}
