...
-(void)checkWin{
    if([contwinner intValue]==10){
        ...
        switch(turnos.intValue){
            case 10:bonoturnos=[NSNumber numberWithInt:turnos.intValue*3000];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 3000",turnos.stringValue];
                break;
            case 11:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2900];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2900",turnos.stringValue];
                break;
            case 12:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2800];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2800",turnos.stringValue];
                break;
            case 13:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2700];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2700",turnos.stringValue];
                break;
            case 14:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2600];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2600",turnos.stringValue];
                break;
            case 15:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2500];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2500",turnos.stringValue];
                break;
            case 16:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2400];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2400",turnos.stringValue];
                break;
            case 17:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2300];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2300",turnos.stringValue];
                break;
            case 18:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2200];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2200",turnos.stringValue];
                break;
            case 19:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2100];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2100",turnos.stringValue];
                break;
            case 20:bonoturnos=[NSNumber numberWithInt:turnos.intValue*2000];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 2000",turnos.stringValue];
                break;
            case 21:bonoturnos=[NSNumber numberWithInt:turnos.intValue*1900];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 1900",turnos.stringValue];
                break;
            case 22:bonoturnos=[NSNumber numberWithInt:turnos.intValue*1800];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 1800",turnos.stringValue];
                break;
            case 23:bonoturnos=[NSNumber numberWithInt:turnos.intValue*1700];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 1700",turnos.stringValue];
                break;
            case 24:bonoturnos=[NSNumber numberWithInt:turnos.intValue*1600];
                TVTbonoturnos=[NSString stringWithFormat:@"%@ x 1600",turnos.stringValue];
                break;
            case 25:bonoturnos=[NSNumber numberWithInt:turnos.intValue*1500];
